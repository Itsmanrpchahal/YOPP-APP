...
class EditProfileScreen extends StatefulWidget {
  static route(UserProfile profile, bool isInitialSetupScreen) => FadeRoute(
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void checkForUpdate(BuildContext context) {
    BlocProvider.of<EditProfileBloc>(context).add(GetUpdatedUserProfile());
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(mainAxisSize: MainAxisSize.max, children: [
              ...
              (profile?.selectedSport?.weightRequired == null)
                  ? SizedBox(width: 20)
                  : Container(),
