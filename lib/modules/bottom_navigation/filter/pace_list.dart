...
class PaceLevelList extends StatelessWidget {
  final String previousScreenName;
  final String previousSelection;
  final PaceLevel selectedPaceLevel;
  final Function onBack;
  final Function(PaceLevel) onSelected;

  const PaceLevelList({
    Key key,
    @required this.previousSelection,
    @required this.selectedPaceLevel,
            ...
            child: Center(
              child: Wrap(
                ...
                children: PaceLevel.values
                    .where((element) => element != PaceLevel.all)
                    .map((e) => Container(
